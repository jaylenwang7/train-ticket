...
{{/*
Jaeger-specific helpers
*/}}

{{/*
Expand the name of the chart for Jaeger.
*/}}
{{- define "jaeger.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" }}-jaeger
{{- end }}

{{/*
Create chart name and version as used by the chart label for Jaeger.
*/}}
{{- define "jaeger.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}
